...
func relocate_table(start: Vector3, middle: Vector3, end: Vector3):
	# Project all points to the same horizontal plane (middle height)
	start.y = middle.y
	end.y = middle.y
	...
	# Radius from the three points (after projection)
	...
	# Rotate so -Z points toward middle
	...
	# Debug
	print("=== Cylinder Placement (Horizontal) ===")
	print("Center: ", center)
	print("Radius used: ", radius)
	print("Dist start:  ", r1)
	print("Dist middle: ", r2)
	print("Dist end:    ", r3)
